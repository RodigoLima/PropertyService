...
namespace ManagementService.Infrastructure.Migrations
{
    ...
    [Migration("20260111164348_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagementService.Domain.Entities.Propriedade", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManagementService.Domain.Entities.Talhao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManagementService.Domain.Entities.Talhao", b =>
                {
                    b.HasOne("ManagementService.Domain.Entities.Propriedade", "Propriedade")
                        .WithMany("Talhoes")
